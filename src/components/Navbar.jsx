          ...
          <nav className="flex justify-between bg-gray-900 text-white w-full">
            <div className="px-5 xl:px-12 py-5 flex w-full items-center">
              ...
              <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                <li>
                  <a
                    className={`hover:text-gray-200 flex items-center relativ`}
                    href="#"
            ...
            <div className='border-2 flex mr-6 items-center self-center border-gray-200 p-1 rounded-md px-3 hover:text-gray-200  xl:hidden h-fit'>
              <button >{1 == 1 ? "Logout" : "Login"}</button>
