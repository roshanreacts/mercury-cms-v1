    ...
    <ToastContainer/>
      <form onSubmit={formik.handleSubmit}>
        <div className="flex flex-col items-center justify-center bg-gray-200 h-[90vh]">
          <div
            className="flex flex-col items-center justify-center p-8 rounded-lg border-2 border-gray-900 min-w-[35%] bg-white"
            style={{ boxShadow: "8px 12px 32px 0px rgba(0,0,0,0.1)" }}
          >
            ...
            <div className="mt-6 w-[30%]">
              <button
                disabled={loading}
                className="w-full p-2 bg-gray-900 text-white rounded flex justify-center items-center"
                type="submit"
              >
            ...
            <div className="mt-4">
              <Link href="/forgotpassword" className="text-blue-700 text-sm">
                Forgot Password?
              </Link>
            </div>
          </div>
